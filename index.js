const apiKey = "90bfdac6d036f893e82af852571bb426";
...
// Fetch movies from search based on url
...
function createMovieCard(movie) {
    ...
    const truncatedTile = original_title.length > 15 ? original_title.slice(0, 15) + "..." : original_title;
            ...
            <div class="card-content">
             <div class="card-header">
                <div class="left-content">
                    <h3 style="font-weight: 600">${truncatedTile}</h3>
...
// clear result element for new search
